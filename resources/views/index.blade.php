...
@section('content')
  ...
  >
    ...
    <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center text-white px-4">
      <h1 class="text-4xl md:text-6xl font-bold mb-4">Kelurahan Winduherang</h1>
      <p class="text-lg md:text-2xl mb-6">Lokasi Desa</p>
      <div class="flex items-center space-x-4">
        <button @click="prev()" class="p-3 bg-green-600 rounded-full hover:bg-green-500 transform hover:scale-110 transition">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/>
          </svg>
        </button>
        <button @click="next()" class="p-3 bg-green-600 rounded-full hover:bg-green-500 transform hover:scale-110 transition">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
  ...
  <section class="py-16 bg-green-50 relative overflow-hidden">
    ...
    <svg class="absolute top-0 left-0 opacity-10 w-96 h-96 text-green-100 -z-10" fill="none" viewBox="0 0 500 500">
      <path fill="currentColor" d="M437.5,123.1c33.3,48.1,45.4,118.8,6.1,173.1s-130.4,87.1-210.4,79.1s-153.6-53.8-187.5-108.2S2.7,123.5,68.8,67.5S404.2,75,437.5,123.1z"/>
    </svg>
    ...
    <div class="max-w-6xl mx-auto px-4 flex flex-col lg:flex-row items-start gap-10 relative z-10">
      ...
      <div class="lg:w-1/3 w-full flex justify-center">
        <img src="{{asset('images/pejabat.png')}}" alt="Foto Lurah" class="rounded-xl shadow-xl object-cover w-full max-w-xs border-4 border-green-200 animate-fade-in">
      </div>
      ...
      <div class="lg:w-2/3 w-full space-y-6 animate-fade-in">
        <div class="flex items-center gap-2">
          ...
          <span class="ml-2 inline-block bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded-full shadow-sm">#PelayananPrima</span>
        </div>
        ...
        <div class="space-y-4 text-gray-800 leading-relaxed">
          ...
          <p>
            Kepada masyarakat Kelurahan Sukamulya sekalian yang saya banggakan. Pada kesempatan yang berbahagia ini, kiranya tiada kata-kata yang patut untuk kita ucapkan terlebih dahulu melainkan puji syukur yang sedalam-dalamnya, atas rahmat dan karunia Allah SWT sehingga pembuatan website Kelurahan Sukamulya dapat terlaksana dengan baik.
          </p>

          <!-- Konten tersembunyi -->
          <div id="sambutanHidden" class="hidden space-y-4">
            <p>
              Website ini kami hadirkan secara mandiri untuk mengikuti perkembangan dunia Teknologi Informasi (IT) yang kian pesat. Lahir dari sebuah ide kreatif dan inovatif, serta merupakan sebuah terobosan atas hasil kolaborasi kami dengan mahasiswa Poltekesos untuk lebih mendekatkan diri kepada masyarakat luas.
            </p>
            <p>
              Melalui website ini kami berupaya agar informasi tentang Kelurahan Sukamulya menjadi lebih terbuka dan interaktif. Profil, kegiatan dan program kelurahan serta jenis dan prosedur pelayanan dapat diakses oleh masyarakat secara langsung dan cepat.
            </p>
            <p>
              Sebagai Lurah Kelurahan Sukamulya, kami mengajak kepada masyarakat Kelurahan Sukamulya untuk ikut pula berpartisipasi menyumbangkan ide, kreasi dan informasinya agar website ini menarik minat pembaca dan menunjang kami untuk memperkenalkan potensi-potensi yang ada di Kelurahan Sukamulya kepada daerah lain.
            </p>
            <p>
            ...
            <p>
              Semoga dengan adanya Website Kelurahan Sukamulya ini dapat bermanfaat dan menjadi salah satu upaya peningkatan pelayanan desa. Namun disadari bahwa upaya kami ini masih jauh dari kesempurnaan. Untuk itu kritik, saran, dan masukan yang konstruktif, kreatif dan inovatif sangat kami nantikan demi penyempurnaan website ini.
            </p>
          ...
          <!-- Tombol -->
          <button onclick="toggleSambutan()" id="toggleButton" class="text-green-700 font-semibold mt-2 inline-flex items-center hover:text-green-900 transition duration-200">
            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path d="M10 3a1 1 0 01.894.553l5 10a1 1 0 01-.894 1.447H5a1 1 0 01-.894-1.447l5-10A1 1 0 0110 3z" /></svg>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      @foreach (['Jumat Bersih','Pemeliharaan Area Gazebo Komunitas','Gotong Royong'] as $i => $title)
        <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group relative">
          <!-- Gambar Thumbnail -->
          <div class="relative">
            <img src="https://picsum.photos/seed/{{ $i }}/600/400" alt="{{ $title }}" class="w-full h-52 object-cover transition-transform duration-300 group-hover:scale-105">
            <div class="absolute bottom-2 left-2 bg-green-700 text-white text-xs px-3 py-1 rounded-full shadow">10 Apr 2025</div>
          </div>

          <!-- Konten Berita -->
          <div class="p-6 space-y-3">
            <span class="inline-block text-xs font-medium uppercase tracking-wide text-green-700 bg-green-100 px-2 py-1 rounded-full">
              @if($i===0) Kegiatan Warga @elseif($i===1) Infrastruktur @else Lingkungan @endif
            </span>
            ...
            <p class="text-gray-600 text-sm leading-relaxed line-clamp-3">
              @if($i===0)
                Warga Kelurahan Winduherang berkumpul di jalan lingkungan untuk menjalankan program kebersihan bersama.
              @elseif($i===1)
            ...
            <!-- Tombol Popup -->
            <div class="mt-4">
              <button onclick="openModal({{ $i }})" class="text-green-700 font-medium inline-flex items-center hover:underline transition">
                Baca Selengkapnya
...
<script>
  ...
  <section class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4">
      <h3 class="text-3xl md:text-4xl font-semibold text-center text-green-700 mb-14 tracking-tight" data-aos="fade-up">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        @foreach (range(1,8) as $id)
          <div 
            class="group overflow-hidden rounded-2xl border border-green-100 bg-white shadow-sm hover:shadow-md transition duration-300 cursor-pointer"
            data-aos="zoom-in" 
          ...
          >
            <img
              src="https://picsum.photos/id/{{ 100 + $id }}/400/300"
  ...
  <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
    ...
    <div class="space-y-6">
      ...
      @foreach ([
        ...
        <div class="border-l-4 border-green-600 pl-5 pr-4 bg-white rounded-xl shadow-lg p-5 hover:bg-green-50 transition duration-300">
