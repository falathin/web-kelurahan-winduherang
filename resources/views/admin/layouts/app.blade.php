...
<body class="bg-desa-krem text-gray-800 font-sans">
  ...
  <aside x-show="sidebarOpen"
    ...
    <nav class="p-6 space-y-2">
      ...
      <button class="w-full mt-4 py-2 px-4 text-left bg-red-500 hover:bg-red-600 rounded">Log Out</button>
    </nav>
  </aside>
  ...
  <aside class="hidden md:fixed md:inset-y-0 md:w-64 md:flex md:flex-col bg-desa-hijau text-white shadow-lg">
    ...
    <nav class="flex-1 p-6 space-y-2">
      ...
      <button class="w-full mt-6 py-2 px-4 text-left bg-red-500 hover:bg-red-600 rounded">Log Out</button>
    </nav>
  </aside>
