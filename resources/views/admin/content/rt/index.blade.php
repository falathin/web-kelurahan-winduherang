  ...
  <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
    @if($rts->isEmpty())
      <div class="p-6 text-center text-gray-500">
        <p class="text-lg">😔 Belum ada data RT yang ditambahkan.</p>
        <p class="mt-2">Klik tombol <strong>Tambah RT</strong> untuk menambahkan data baru.</p>
      </div>
    @else
      <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Nomor RT</th>
